...
public class LogFile implements Parcelable
{
    ...
    LogFile(File backupSubDir, String packageName)
    {
    ...
    static void writeLogFile(File backupSubDir, AppInfo appInfo, int backupMode)
    {
    ...
    static void writeLogFile(File backupSubDir, AppInfo appInfo, int backupMode, boolean encrypted)
    {
